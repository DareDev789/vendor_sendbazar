...
export const metadata = {
    ...
    description: "Consultez les conditions générales de vente de la société LOVAPI. Informations sur les droits et obligations des parties, les modalités de livraison, les conditions de paiement, et bien plus encore.",
    keywords: "conditions générales de vente, CGV, LOVAPI, vente en ligne, droits du consommateur, modalités de livraison, conditions de paiement",
    authors: [{ name: "LOVAPI" }],
};

export default function Conditions() {
    return (
        <div className="container mx-auto max-sm:px-10 my-10">
            <div className="flex flex-col gap-2">
                <h1 className="text-3xl font-bold text-[#f5848c]">
                    Conditions générale de vente
                </h1>
                <p className="h-0.5 w-12 bg-[#f5848c]"></p>
            </div>
            <p className="text-md mt-4">
                Entre la Société LOVAPI,
                <br />
                <br />
                ...
                <br />
                <br />
                sous le numéro SIRET 88787365100012.
                <br />
                <br />
            ...
            <div className="text-md">
                <h1 className="uppercase underline font-bold mt-10">PRÉAMBULE</h1>
                <p className="mt-4">
                    Le Vendeur est éditeur de divers Produits et Services à destination de consommateurs, commercialisés par l’intermédiaire de ses sites Internet (sendbazar.com). La liste et le descriptif des biens et services proposés par la Société peuvent être consultés sur les sites susmentionnés.
                </p>
            </div>
            <div className="text-md">
                <div className="mt-10 flex gap-2">
                    <p className="underline font-bold">Article 1 :</p>
                    <p className="font-light no-underline">Objet</p>
                </div>
                <p className="mt-4">
                    Les présentes Conditions Générales de Vente déterminent les droits et obligations des parties dans le cadre de la vente en ligne de Produits ou Services et prestation proposés par le Vendeur.
                </p>
            </div>
            <div className="text-md">
                <div className="mt-10 flex gap-2">
                    <p className="underline font-bold">Article 2 :</p>
                    <p className="font-bold no-underline">Dispositions générales</p>
                </div>
                <p className="mt-4">
                    Les présentes Conditions Générales de Vente (CGV) régissent les ventes de Produits ou de Services-prestations, effectuées au travers des sites Internet de la Société, et sont partie intégrante du Contrat entre l’Acheteur et le Vendeur. Elles sont pleinement opposables à l’Acheteur qui les a acceptées avant de passer commande.
                    <br />
                    <br />
            ...
            <div className="text-md">
                <div className="mt-10 flex gap-2">
                    <p className="underline font-bold">Article 3 :</p>
                    <p className="font-bold no-underline">Prix</p>
                </div>
                <p className="mt-4">
            ...
            <div className="text-md">
                <div className="mt-10 flex gap-2 max-sm:flex-col">
                    <p className="underline font-bold">Article 4 :</p>
                    <p className="font-bold no-underline">Conclusion du contrat en ligne</p>
                </div>
                <p className="mt-4">
                    ...
                    <br />
                    <br />
                    La langue proposée pour la conclusion du contrat est la langue française. Les modalités de l’offre et des conditions générales de vente sont accessibles sur le site du vendeur par l’acheteur lors de la commande et archivées sur le site web du Vendeur.
                    <br />
                    <br />
                    Le cas échéant, les règles professionnelles et commerciales auxquelles l’auteur de l’offre entend se soumettre sont consultables dans la rubrique 'règles annexes' des présentes CGV, consultables sur le site du vendeur à l’adresse suivante : https://sendbazar.com/conditions-generales-de-vente/.
                    <br />
                    <br />
            ...
            <div className="text-md">
                <div className="mt-10 flex gap-2 max-sm:flex-col">
                    <p className="underline font-bold">Article 5 :</p>
                    <p className="font-bold no-underline">Produits et services-prestations</p>
                </div>
                <p className="mt-4">
                    Les caractéristiques essentielles des biens, des prestations, des services et leurs prix respectifs sont mis à disposition de l’acheteur sur les sites Internet de la société, de même, le cas échéant, que le mode d’utilisation du produit.
                    <br />
                    <br />
                    Conformément à l’article L112-1 du Code de la consommation, le consommateur est informé, par voie de marquage, d’étiquetage, d’affichage ou par tout autre procédé approprié, des prix et des conditions particulières de la vente et de l’exécution des Services-prestation avant toute conclusion du contrat de vente.
                    <br />
                    <br />
                    Dans tous les cas, le montant total dû par l’Acheteur est indiqué sur la page de confirmation de la commande. Le prix de vente du produit est celui en vigueur indiqué au jour de la commande, celui-ci ne comportant pas les frais de ports.
                    <br />
                    <br />
                    Ces éventuels frais sont indiqués à l’Acheteur lors du processus de vente, et en tout état de cause au moment de la confirmation de la commande. Le Vendeur se réserve la possibilité de modifier ses prix à tout moment, tout en garantissant l’application du prix indiqué au moment de la commande.
                    <br />
                    <br />
                    Lorsque les produits ou services ne sont pas exécutés immédiatement, une information claire est donnée sur la page de présentation du produit quant aux dates de livraison des produits ou services-prestations.
                    <br />
                    <br />
            ...
            <div className="text-md">
                <div className="mt-10 flex gap-2">
                    <p className="underline font-bold">Article 6 :</p>
                    <p className="font-bold no-underline">Conformité</p>
                </div>
                <p className="mt-4">
                    ...
                    <br />
                    <br />
                    Indépendamment de toute garantie commerciale, le Vendeur reste tenu des défauts de conformité et des vices cachés du produit. Conformément à l’article L.217-4, le vendeur livre un bien, des services-prestations conformes au contrat et répond des défauts de conformité existant lors de la délivrance.
                    <br />
                    <br />
                    Il répond également des défauts de conformité résultant de l’emballage, des instructions de montage ou de l’installation lorsque celle-ci a été mise à sa charge par le contrat ou a été réalisée sous sa responsabilité.
                    <br />
                    <br />
                    Conformément aux dispositions légales en matière de conformité et de vices cachés (art. 1641 c.c.v.), le Vendeur rembourse par un avoir ou échange les produits défectueux ou ne correspondant pas à la commande.
                    <br />
                    <br />
                    Le remboursement par avoir peut être demandé de la manière suivante : Le produit doit être renvoyé à la société partenaire de lovapi à (Madagascar) dans le plus bref délai et dès réception de celui-ci, vous serez remboursé par un avoir directement avec un code promo utilisé utilisable sans date limite.
                </p>
            </div>
            <div className="text-md">
                <div className="mt-10 flex gap-2">
                    <p className="underline font-bold">Article 7 :</p>
                    <p className="font-bold no-underline">Clause de réserve de propriété</p>
                </div>
                <p className="mt-4">
            ...
            <div className="text-md">
                <div className="mt-10 flex gap-2">
                    <p className="underline font-bold">Article 8 :</p>
                    <p className="font-bold no-underline">Modalités de livraison</p>
                </div>
                <p className="mt-4">
                    Les produits sont livrés à l’adresse de livraison ou point relais qui a été indiquée lors de la commande et dans les délais indiqués. Ces délais ne prennent pas en compte le délai de préparation de la commande.
                    <br />
                    <br />
                    Lorsque la livraison nécessite une prise de rendez-vous avec le Client (Cela sera comme indiqué lors de la commande). Lorsque le Client commande plusieurs produits en même temps ceux-ci peuvent avoir des délais de livraison différents acheminés selon les modalités suivantes _ (décrire la procédure).
                    <br />
                    <br />
                    En cas de retard d’expédition, nous vous contacterons pour vous prévenir. En cas de retard de livraison, le Client dispose de la possibilité de résoudre le contrat dans les conditions et modalités définies à l’Article L 138-2 du Code de la consommation.
                    <br />
                    <br />
                    Le Vendeur procède alors au remboursement du produit et aux frais « aller » dans les conditions de l’Article L 138-3 du Code de la consommation.
                    <br />
                    <br />
            ...
            <div className="text-md">
                <div className="mt-10 flex gap-2">
                    <p className="underline font-bold">Article 9 :</p>
                    <p className="font-bold no-underline">Disponibilité et présentation</p>
                </div>
                <p className="mt-4">
                    En cas d’indisponibilité d’un article pour une période supérieure à jours ouvrables, vous serez immédiatement prévenu des délais prévisibles de livraison et la commande de cet article pourra être annulée sur simple demande.
                    <br />
                    <br />
            ...
            <div className="text-md">
                <div className="mt-10 flex gap-2">
                    <p className="underline font-bold">Article 10 :</p>
                    <p className="font-bold no-underline">Paiement</p>
                </div>
                <p className="mt-4">
                    ...
                    <br />
                    <br />
                    Les informations transmises sont chiffrées dans les règles de l’art et ne peuvent être lues au cours du transport sur le réseau. Une fois le paiement lancé par le Client, la transaction est immédiatement débitée après vérification des informations.
                    <br />
                    <br />
            ...
            <div className="text-md">
                <div className="mt-10 flex gap-2">
                    <p className="underline font-bold">Article 11 :</p>
                    <p className="font-bold no-underline">Délai de rétractation</p>
                </div>
                <p className="mt-4">
                    ...
                    <br />
                    <br />
                    Le droit de rétractation peut être exercé en contactant la Société de la manière suivante : depuis votre espace client ou par mail au retractation@sendbazar.com en indiquant votre numéro de commande.
                    <br />
                    <br />
                    Nous informons les Clients que conformément aux dispositions des articles L. 221-18 à L. 221-28 du Code de la consommation, ce droit de rétractation ne peut être exercé pour des produits périssables et avec des étiquettes déjà arrachées ou produits abîmés.
                    <br />
                    <br />
                    En cas d’exercice du droit de rétractation dans le délai susmentionné, le prix du ou des produits achetés et les frais d’envoi seront remboursés par un avoir, les frais de retour restant à la charge du Client.
                    <br />
                    <br />
                    ...
                    <br />
                    <br />
                    Conformément aux dispositions légales, vous trouverez ci-après le formulaire-type de rétractation à nous adresser à l’adresse suivante : (adresse). Procédure de remboursement : (décrire précisément la procédure de remboursement – en particulier pour les gros achats)
                </p>
            </div>
            <div className="text-md">
                <div className="mt-10 flex gap-2">
                    <p className="underline font-bold">Article 12 :</p>
                    <p className="font-bold no-underline">Garanties</p>
                </div>
                <p className="mt-4">
                    Conformément à la loi, le Vendeur assume les garanties suivantes : de conformité et relative aux vices cachés des produits.
                    <br />
                    <br />
                    Le Vendeur rembourse par un avoir à l’acheteur ou échange les produits apparemment défectueux ou ne correspondant pas à la commande effectuée.
                    <br />
                    <br />
                    La demande de remboursement doit s’effectuer de la manière suivante : via la carte bancaire débitée lors de l’achat ou par bon de commande.
                    <br />
                    <br />
                    Le Vendeur rappelle que le consommateur : – (électroménager) dispose d’un délai de 2 ans à compter de la délivrance du bien pour agir auprès du Vendeur – qu’il peut choisir entre le remplacement et la réparation du bien sous réserve des conditions prévues par les dispositions susmentionnées.
                    <br />
                    <br />
                    Apparemment défectueux ou ne correspondant – qu’il est dispensé d’apporter la preuve de l’existence du défaut de conformité du bien durant les six mois suivant la délivrance du bien.
                    <br />
                    <br />
            ...
            <div className="text-md">
                <div className="mt-10 flex gap-2">
                    <p className="underline font-bold">Article 13 :</p>
                    <p className="font-bold no-underline">Résolution du contrat</p>
                </div>
                <p className="mt-4">
            ...
            <div className="text-md">
                <div className="mt-10 flex gap-2 max-sm:flex-col">
                    <p className="underline font-bold">Article 14 :</p>
                    <p className="font-bold no-underline">Droits de propriété intellectuelle</p>
                </div>
                <p className="mt-4">
            ...
            <div className="text-md">
                <div className="mt-10 flex gap-2">
                    <p className="underline font-bold">Article 15 :</p>
                    <p className="font-bold no-underline">Force majeure</p>
                </div>
                <p className="mt-4">
            ...
            <div className="text-md">
                <div className="mt-10 flex gap-2 max-sm:flex-col">
                    <p className="underline font-bold">Article 16 :</p>
                    <p className="font-bold no-underline">Nullité et modification du contrat</p>
                </div>
                <p className="mt-4">
            ...
            <div className="text-md">
                <div className="mt-10 flex gap-2 max-sm:flex-col">
                    <p className="underline font-bold">Article 17 :</p>
                    <p className="font-bold no-underline">Protection des données personnelles</p>
                </div>
                <p className="mt-4">
            ...
            <div className="text-md">
                <div className="mt-10 flex gap-2 max-sm:flex-col">
                    <p className="underline font-bold">Article 18 :</p>
                    <p className="font-bold no-underline">Information des consommateurs</p>
                </div>
                <p className="mt-4">
                    ...
                    <br />
                    <br />
                    <b>Article 1641 du Code civil :</b>
                    Le vendeur est tenu de la garantie à raison des défauts cachés de la chose vendue qui la rendent impropre à l’usage auquel on la destine, ou qui diminuent tellement cet usage que l’acheteur ne l’aurait pas acquise, ou n’en aurait donné qu’un moindre prix, s’il les avait connus.
                    <br />
                    <br />
                    <b>Article L. 217-4</b>
                    du Code de la consommation : Le vendeur livre un bien conforme au contrat et répond des défauts de conformité existant lors de la délivrance. Il répond également des défauts de conformité résultant de l’emballage, des instructions de montage ou de l’installation lorsque celle-ci a été mise à sa charge par le contrat ou a été réalisée sous sa responsabilité.
                    <b>Article L. 217-5 du Code de la consommation</b>
                    ...
                    <b>Article L. 217-16 du Code de la consommation</b>
