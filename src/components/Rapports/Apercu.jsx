...
export default function Apercu() {
    ...
    const [refunded,setRefunded] = useState(0.0);
    const [billed,setBilled] = useState(0.0);
    ...
    <div className="flex gap-4 p-4">
      <div className="w-1/4 bg-white p-4 rounded-lg shadow">
        <div className="border-b border-gray-300 pb-2 mb-4">
            ...
            <p className="text-sm text-gray-500">ventes brutes au cours de cette période</p>
        </div>
        <div className="border-b border-gray-300 pb-2 mb-4">
            <h1 className="text-4xl font-bold mb-2">{formatPrice(calculatePricetoNewDevise(netSales, 'Eur' , devise), listDevise[devise])}</h1>
            <p className="text-sm text-gray-500">ventes nettes au cours de cette période</p>
        </div>
        <div className="border-b border-gray-300 pb-2 mb-4">
        ...
        <div className="border-b border-gray-300 pb-2 mb-4">
            ...
            <p className="text-sm text-gray-500">remboursé 0 commandes (0 articles)</p>
        </div>
        <div className="border-b border-gray-300 pb-2 mb-4">
        ...
        <div className="border-b border-gray-300 pb-2 mb-4">
            ...
            <p className="text-sm text-gray-500">montant des codes promo utilisés</p>
        </div>
      </div>
